...
\begin{equation}\label{eq:cons_laws}
  {\underline{{L}}}({\tilde{\rho}}^{-2\ell}L(e^{+})^{\ell+1}\phi_{\ell m})=0, \qquad({\tilde{\rho}}^{-2\ell}L(e^{-})^{\ell+1}\phi_{\ell m})=0
\end{equation}
...
\begin{align}\label{eq:inductionstep_commutation}
  ...
  & =-2 N\tilde{\rho} L L\left(e^{+}\right)^{N} \phi-2 N L\left(e^{+}\right)^{N} \phi+(N(N+1)) L\left(e^{+}\right)^{N} \phi +\left(e^{+}\right)^{N} \phi L(N(N+1))+\Delta L\left(e^{+}\right)^{N} \phi-2 \tilde{\rho} L L\left(e^{+}\right)^{N} \phi-2 L\left(e^{+}\right)^{N} \phi= \nonumber \\
  ...
  & =-2 N\tilde{\rho} \tilde{p} L L\left(e^{+}\right)^{N} \phi-N L\left(e^{+}\right)^{N} \phi+N^{2} L\left(e^{+}\right)^{N} \phi +\Delta L\left(e^{+}\right)^{N} \phi-2 \tilde{\rho} L L\left(e^{+}\right)^{N} \phi-2 L\left(e^{+}\right)^{N} \phi.
\end{align}
...
\begin{proof}
  ...
  \begin{equation}\label{eq:coromain_commutation_proof2}
    \sum_{l, m} Y_{l m}\left[L L\left(e^{+}\right)^{l} \phi_{l m}+\frac{2^{l}}{\tilde{\rho}} L\left(e^{+}\right) \phi_{l m}\right]=\frac{1}{\tilde{\rho}^{2}}\left{(l(l+1))\left(e^{+}\right)\left[\sum_{l, m} \phi_{l m} Y_{l m}\right] +\left[\sum_{l_{1} m} \phi_{l m} \Delta Y_{l m}\right]\left(e^{+}\right)^{l}\right}
  \end{equation}
\end{proof}
